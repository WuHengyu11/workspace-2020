...
public class UploadUtil {
	//阿里域名
	public static final String ALI_DOMAIN = "https://luowowo12.oss-cn-huhehaote.aliyuncs.com/";
	...
	public static String uploadAli(MultipartFile file) throws Exception {
		...
		String accessKeyId = "LTAI4FyLc8WS2yZqAfiucWo6";
		String accessKeySecret = "f8QqRkY7F1wxxoZBRLIeJNve01EnSQ";
		// 创建OSSClient实例。
		OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId,accessKeySecret);
		// 上传文件流。
		ossClient.putObject("luowowo12", fileName, file.getInputStream());
		// 关闭OSSClient。
		ossClient.shutdown();
