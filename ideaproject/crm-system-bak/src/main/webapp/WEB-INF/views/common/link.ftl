...
<link rel="stylesheet" href="/js/plugins/bootstrap-validator/css/bootstrapValidator.css">
...
<script src="/js/plugins/bootstrap-validator/js/bootstrapValidator.js"></script>
