        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li name="customerReport"><a href="/courseorder/list.do"><i class="fa fa-circle-o"></i>课程订单管理</a>
                    </li>
                </ul>
            </li>
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li name="customerReport"><a href="/salary/list.do"><i class="fa fa-circle-o"></i>工资管理</a>
                    </li>
                </ul>
            </li>
        </ul>
