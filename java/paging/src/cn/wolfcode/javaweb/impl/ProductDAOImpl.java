...
public class ProductDAOImpl implements IProductDAO {
	...
	public int selectForCount(QueryObject qo) {
		...
		int rows = session.selectOne("cn.wolfcode.javaweb.mappper.ProductMapper.selectForCount",qo);
	...
	@Override
	public List<Product> selectFotList(QueryObject qo) {
		
		//获取连接
		SqlSession session = MybatisUtil.getConnection();
		
		//执行sql
		session.selectList("cn.wolfcode.javaweb.mappper.ProductMapper.selectFotList",qo);
