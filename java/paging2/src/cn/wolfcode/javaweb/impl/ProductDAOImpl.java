...
public class ProductDAOImpl implements IProductDAO {
	...
	public int queryForCount(QueryObject qo) {
		...
		//执行sql
		Integer rows = session.selectOne("cn.wolfcode.javaweb.mappper.ProductMapper.queryForCount",qo);
	...
	public List<?> queryList(QueryObject qo) {
		...
		//执行sql
		List<Product> resultList = session.selectList("cn.wolfcode.javaweb.mappper.ProductMapper.queryForList", qo);
